<?php
  echo "<?xml version='1.0' encoding='UTF-8'?>".'<definitions xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/"
	...
	<types>
		<xs:schema xmlns:tns="http://xmlns.oracle.com/apps/otm/ExternalRating" elementFormDefault="qualified" targetNamespace="http://xmlns.oracle.com/apps/otm/ExternalRating">
			...
			<xs:element name="serviceDays" type="xs:string"/>
			<xs:element name="utcPickupDateTime" type="xs:string" />
			<xs:element name="pickupTimezone" type="xs:string" />
			<xs:element name="utcDeliveryDateTime" type="xs:string" />
			...
			<xs:element name="dimWeight" type="xs:string" />
			...
			<xs:element name="isWeightedCostOnly" type="xs:string"/>
			<xs:element name="costCategoryGid" type="xs:string" />
			<xs:element name="shipUnitGid" type="xs:string" />
			<xs:element name="shipUnitLineSeq" type="xs:string" />
	...
	<service name="ExternalRatingService">
		<port name="ExternalRatingPort" binding="tns:ExternalRatingPortBinding">
			<soap:address location="http://otm-soap.appspot.com/cost_shipment"/>
		</port>
	</service>
</definitions>';
?>